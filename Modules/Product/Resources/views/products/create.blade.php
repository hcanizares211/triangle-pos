            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">{{ __('Create Product') }} <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            <option value="" selected >{{ __('Select Tax Type') }}</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_unit">{{ __('Unit') }} <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="This short text will be placed after Product Quantity."></i> <span class="text-danger">*</span></label>
