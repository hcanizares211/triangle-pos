                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_cost">{{ __('Cost') }} <span class="text-danger">*</span></label>
                                        <input id="product_cost" type="text" class="form-control" min="0" name="product_cost" required value="{{ $product->product_cost }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_price">{{ __('Price') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            ...
                                            <option {{ $product->product_tax_type == 1 ? 'selected' : '' }}  value="1">{{ __('Exclusive') }}</option>
                                            <option {{ $product->product_tax_type == 2 ? 'selected' : '' }} value="2">{{ __('Inclusive') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_unit">{{ __('Unit') }} <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="{{ __('This short text will be placed after Product Quantity.') }}"></i> <span class="text-danger">*</span></label>
...
@push('page_scripts')
    <script>
        ...
        Dropzone.options.documentDropzone = {
            ...
            maxFiles: 3,
            addRemoveLinks: true,
            dictRemoveFile: "<i class='bi bi-x-circle text-danger'></i> {{ __('Remove') }}",
            headers: {
